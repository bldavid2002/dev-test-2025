...
class NutritinalValue(BaseModel):
    ...
    amount: Optional[str] = Field(None, description = "The numerical value of the amount of nutrient found e.g. 12.0, can be null if not found.")
...
class ExtractionResult(BaseModel):
    ...
    nutritionalValues: List[NutritinalValue] = Field(..., description = "A list of extracted nutritional components")
